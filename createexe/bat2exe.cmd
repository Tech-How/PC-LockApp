@echo off
del /q "%TEMP%\BAT2EXE_WS.ini"
del /q "%TEMP%\BAT2EXE_TF.ini"
del /q "%localappdata%\PC LockApp\lockapp2.exe"
REM BY ISLAM ADEL
REM BAT2EXE.NET
SET VER=2.0
SET VERd=2021-02-16
...
set WS="%localappdata%\PC LockApp\bin\exedata"
...
set TF="%localappdata%\PC LockApp"
REM maximum fail retries
